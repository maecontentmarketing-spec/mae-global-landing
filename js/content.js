...
const DEFAULT_CONTENT = {
  ...
  // 四大亮点：改版后左边放一张照片（后台自由上传/更换），右边是 4 条「立体图示 + 标题 + 描述」，
  // 图示跟 GROW System 那 5 个用同一套风格（icons/ 资料夹里的 png，写档名不用写 .png）。
  highlights: {
    photo: "",
    items: [
      { icon: "phone", title: "一部手机就能开始", desc: "不需要额外设备、不需要技术背景" },
      { icon: "clock", title: "时间自由", desc: "每天 2 小时，利用零碎时间就能开始" },
      { icon: "trophy", title: "产品竞争力", desc: "专利成分、真实效果，经得起市场检验" },
      { icon: "globe", title: "市场竞争力", desc: "一套可复制的打法，让你不只赚马币，也能赚新币、港币——我们已经在马来西亚、新加坡、香港三地布局，有实际跑通的海外发展路径" }
    ]
  },
  brand: {
  ...
  event: {
    // Zoom 分享会海报 banner（选填）：放在这张紫色卡片最上面，纯粹是视觉钩子，
    // 不上传的话这个板块维持原本纯文字呈现，不会因为没图而空一块。
    poster_image: "",
